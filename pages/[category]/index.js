...
const index = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      text: 'text-BLUE',
      fill: 'fill-BLUE',
      keywords: `رياضة,sports news,اخبار رياضيه,football news,خبر رياضي,كرة قدم,اخبار كرة قدم,خبر كرة,الرياضه,الاخبار الرياضية
        رياضة
sports news
اخبار رياضيه
football news
...
شؤون سياسية
  `,
    ...
    },
    {
      ...
      text: 'text-RED',
      fill: 'fill-RED',
      keywords: `اخبار ترند, ترند الاخبار, اخبار ترند العرب, ترند الاخبارية, اخبار عاجلة ترند, اخبار محلية ترند, اخبار حكومية ترند,ترند, ترند مشاهير, فيديو ترند, صور ترند
        فضائح مشاهير
trend news
ترند
اخبار مشاهير
...
مشاهير لبنان
    ...
    },
    {
      ...
      text: 'text-GREEN',
      fill: 'fill-GREEN',
      keywords: `اخبار التكنولوجيا والالعاب , الاخبار التكنولوجية, اخبار العاب, العاب الاخبارية, اخبار عاجلة العاب, اخبار محلية العاب, اخبار العاب عربي, اصدارات العاب, اخر اخبار الالعاب
        xbox
ps4
playstation
online games news
...
`,
    ...
    },
    {
      ...
      text: 'text-GREEN',
      fill: 'fill-GREEN',
      keywords: `اخبار التكنولوجيا , الاخبار التكنولوجية, اخبار تكنولوجية, تكنولوجيا الاخبارية, اخبار عاجلة تكنولوجية, اخبار محلية تكنولوجيا, اخبار تكنولوجيا عربي, اصدارات تكنولوجيا, اخر اخبار التكنولوجيا
        اخبار تكنولوجيا
 اخبار ميتافيرس
Technology news
تكنولوجي اخبار
...
اخبار الاقمار الصناعية
أخبار العلوم والتكنولوجيا
مجالات الهواتف الذكية
مجالات الإنترنت
اخبار شبكات التواصل الاجتماعي
اخبار الأمن الإلكتروني 
البرمجيات
الاختراعات التكنولوجية
    ...
    },
    {
      ...
      text: 'text-GREEN',
      fill: 'fill-GREEN',
      keywords: `اخبار اقتصاد, مال وأعمال الاخبار, اخبار العملات الرقمية , اخبار تداول العملات الرقمية , اخبار عاجلة التداول, اخبار محلية اقتصادية, اخبار حكومية اقتصادية,العملات الرقمية, العملات الرقمية والتداول العالمي, اخبار التكنولوجيا, اخبار تكنولوجيا واقتصاد
        اخبار اقتصادية
اقتصاد الدول
اقتصاد 
مال واعمال
...
السوق المالي
    ...
    },
    {
      ...
      text: 'text-YELLOW',
      fill: 'fill-YELLOW',
      keywords: `اخبار سياسية, غزو أوكرانيا الاخبار, اخبار الحروب , اخبار الغزو الروسي , اخبار عاجلة غزو أوكرانيا, اخبار عالمية , اخبار حكومية سياسية,غزو أوكرانيا وامريكا, غزو أوكرانيا, روسيا, الحرب العالمية, اخبار غزو أوكرانيا وروسيا, اخبار غزو أوكرانيا 
        politics news
سياسيه
اخبار سياسه
politics news
...
شؤون سياسية`,
    ...
    },
    {
      ...
      text: 'text-YELLOW',
      fill: 'fill-YELLOW',
      keywords: `اخبار الخليج العربي, الاخبار في الخليج العربي, اخبار العرب, الخليج العربي الاخبارية, اخبار عاجلة الخليج العربي, اخبار محلية في الخليج العربي, اخبار حكومية الخليج العربي, قرارات الحكومة في الخليج العربي, شروط السفر الى الخليج العربي
        politics news
سياسيه
اخبار سياسه
politics news
...
مجلس التعاون
مؤتمر سياسي
نواب, قرار دول, الاتجاه المعاكس, شؤون سياسية`,
    ...
    },
    {
      ...
      text: 'text-YELLOW',
      fill: 'fill-YELLOW',
      keywords: `اخبار الشأن الدولي, الشأن الدولي الاخبار, اخبار الشأن الدولي,  الشأن الدولي الاخبارية, اخبار عاجلة  الشأن الدولي, اهم اخبار الشأن الدولي, اخبار حكومية  الشأن الدولي, الشأن الدولي, قرارات حكومية دولية
        politics news
        سياسيه
        اخبار سياسه
        politics news
    ...
    },
    {
      ...
      text: 'text-YELLOW',
      fill: 'fill-YELLOW',
      keywords: `اخبار الشرق الأوسط, الشرق الأوسط الاخبار, اخبار الشرق الأوسط العرب,اخبار الشرق الأوسط عاجل, الشرق الأوسط الاخبارية, اخبار عاجلة الشرق الأوسط,الشرق الأوسط, الشرق الأوسط قرارات حكومية
        politics news
        سياسيه
        اخبار سياسه
        politics news
          ...
          all_news ? (
            <section className="text-black mx-auto w-11/12 bg-white lg:w-10/12 lg:pt-10">
              ...
              <section className="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-16">
                {/* <section className="flex  lg:gap-20"> */}
                      ...
                      >
                        ...
                        <section className="grid bg-GRAY100 lg:grid ">
                          ...
                          <div className=" py-1.5 px-3 sm:mb-0 lg:mb-1 lg:px-2 lg:py-2">
                            <div className="my-3 mb-2 inline-block font-TSExtra text-sm md:my-20 md:text-lg lg:my-0 lg:mb-0 lg:text-xl">
                              {item.stories_headlines}
                            </div>
                            <div className="my-3 mb-2 inline-block font-TSmedium text-xs md:my-20 md:text-lg lg:my-0 lg:mb-0 lg:pt-1.5 lg:text-sm">
