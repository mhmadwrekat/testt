        ...
        <>
          <div className="flex justify-between ">
            <div className="my-3 mt-1 lg:mt-2">
              ...
              {description && (
                <p
                  className={`text-white hidden w-full px-1 pb-5 font-TSmedium text-lg lg:grid lg:text-xl`}
                >
                  {description}
                </p>
              )}
          ...
          {description && (
            <p
              className={`text-white grid w-full px-1 pb-2 font-TSmedium text-lg lg:hidden lg:text-xl`}
            >
              {description}
            </p>
          )}
