...
const Like = ({ user_id, isLoved, story_id, bottom }) => {
  ...
  return (
    <React.Fragment>
      <div
        className={`${bottom} absolute right-1 rounded-full lg:bottom-0`}
        loading="eager"
      >
        <svg
          loading="eager"
          ...
          className=" absolute right-1 bottom-0 m-0 h-8 w-8 cursor-pointer"
        >
          <g filter="url(#a)">
        ...
        {openLike && (
          <Fade>
            <div className="flex rounded-full bg-white" loading="eager">
              <div
                loading="eager"
