...
const Footer = () => {
  ...
  return (
    <React.Fragment>
      <div>
        <footer className="from-primary to-secondary bg-gradient-to-r py-5">
          <div className="mx-auto max-w-7xl overflow-hidden ">
            <h1 className="text-md text-white my-3 mr-1 text-center font-TSbold">
              إستخدم التطبيق لتجربة أفضل
            </h1>
            <div className="mx-auto block flex  w-full justify-center">
              <span className="relative mx-2 inline-block w-32 cursor-pointer ">
                <Image
                  src={appleStore}
                  alt="apple Store"
                  onClick={() => {
              ...
              <span className="relative inline-block w-32  cursor-pointer">
                <Image
                  src={googlePlay}
                  alt="google Play"
                  onClick={() => {
        ...
        <div className=" text-center">
          <div className=" my-3">
            ...
            <svg
              ...
              width="45"
              height="45"
              className="texr-purple-light mx-auto inline-block cursor-pointer "
              viewBox="0 0 66 65"
              fill="none"
            ...
            <svg
              ...
              width="45"
              height="45"
              className="mx-auto mr-7 inline-block cursor-pointer"
              viewBox="0 0 65 65"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <label className="text-xs"> Terms of Service</label> */}
          <div className="border-gray-400 mx-auto mt-1 w-full border-t py-2 text-xs lg:w-11/12">
            Copyright &#169; {new Date().getFullYear()} | Alzubda App
          </div>
        </div>
      </div>
    </React.Fragment>
