...
const Nav = () => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="mx-4 flex justify-between border-b-3 border-Purp lg:mx-10">
        <div className="flex">
          <div className=" mt-2 lg:mx-8 lg:mt-5 lg:mb-2">
            <svg
              ...
              className="cursor-pointer fill-Purp hover:fill-SKY"
              onClick={() => router.replace('/')}
            >
              <path
                className="fill-Purp hover:fill-SKY"
                fillRule="evenodd"
                clipRule="evenodd"
        ...
        <div className="float-right my-5 mr-4 sm:flex md:mr-20 lg:mr-24 lg:hidden">
          ...
          <div className=" hidden pr-20 font-TSbold text-lg lg:mt-3 lg:flex">
            ...
            <button className="my-auto ml-10 lg:cursor-pointer">المدونة</button>
            <buttons className="my-auto ml-10 lg:cursor-pointer">أخبار</buttons>
