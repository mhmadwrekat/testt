export default function FifthSection() {
  ...
  return (
    <div className="grid h-full grid-cols-1 ">
      <div className="bg-Purp500 bg-fifth-bg bg-cover bg-no-repeat">
        <div className=" pt-32 text-center ">
          <label className="space-between font-TSbold text-3xl text-white lg:text-7xl ">
            حمل التطبيق الان لقراءة الأخبار بطريقة
            <br /> جديدة وعصرية
          </label>

          <div className="my-20 block">
            <span className="relative mx-2 inline-block w-36 cursor-pointer lg:w-auto ">
              <img
            ...
            <span className="relative inline-block w-36 cursor-pointer lg:w-auto">
              <img
      ...
      <div className="mt-24 text-center">
        <label className="space-between text-center font-TSmedium text-3xl text-GRAY400 lg:text-5xl ">
        ...
        <div className="my-20 lg:my-32">
          ...
          <svg
            ...
            width="65"
            height="65"
            className="mx-auto mr-1 ml-1 inline-block cursor-pointer md:mr-6 md:ml-6 lg:mr-12 lg:ml-12"
            viewBox="0 0 65 65"
            fill="none"
          ...
          <svg
            onClick={() => {
              NewTab('https://www.youtube.com/channel/UC-0-lhAWZAg3MJcFgC-daVg')
            }}
            width="65"
            height="65"
            className="mx-auto mr-1 ml-1 inline-block cursor-pointer  md:mr-6 md:ml-6  lg:mr-12 lg:ml-12"
